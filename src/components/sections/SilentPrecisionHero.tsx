...
const BRAND_LOGOS = [
    // Tailwind CSS
    () => (
        <svg className="h-[22px] sm:h-[28px] w-auto opacity-55 hover:opacity-100 transition-opacity"
             xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 262 33">
            <path fill="#22d3ee" fillRule="evenodd" clipRule="evenodd"
            ...
            <path fill="rgba(245,245,247,0.78)" fillRule="evenodd" clipRule="evenodd"
    ...
    () => (
        <div
            className="flex items-center justify-start font-bold text-sm md:text-base gap-2 opacity-55 hover:opacity-100 transition-opacity"
    ...
    // Next.js
    () => (
        <svg className="h-[14px] sm:h-[18px] opacity-55 hover:opacity-100 transition-opacity"
             xmlns="http://www.w3.org/2000/svg" viewBox="0 0 394 79" style={{fill: 'rgba(245,245,247,0.78)'}}>
            <path d="M261.919 0.0330722H330.547V12.7H303.323V79.339H289.71V12.7H261.919V0.0330722Z"></path>
            <path
                d="M149.052 0.0330722V12.7H94.0421V33.0772H138.281V45.7441H94.0421V66.6721H149.052V79.339H80.43V12.7H80.4243V0.0330722H149.052Z"></path>
            <path
                d="M183.32 0.0661486H165.506L229.312 79.3721H247.178L215.271 39.7464L247.127 0.126654L229.312 0.154184L206.352 28.6697L183.32 0.0661486Z"></path>
            <path d="M201.6 56.7148L192.679 45.6229L165.455 79.4326H183.32L201.6 56.7148Z"></path>
            <path clipRule="evenodd" d="M80.907 79.339L17.0151 0H0V79.3059H13.6121V16.9516L63.8067 79.339H80.907Z"
    ...
    // AWS
    () => (
        <svg className="h-[24px] sm:h-[32px] opacity-55 hover:opacity-100 transition-opacity" version="1.1"
